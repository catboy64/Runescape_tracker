...
class CalcFrame(MyFrame1):
    ...
    def search_player(self,event):
        ...
        for item in skills:
            match item.name:
                case "Attack":
                    self.m_button23.SetLabel(str(item.lvl))
                case "Constitution":
                    self.m_button24.SetLabel(str(item.lvl))
                case "Mining":
                    self.m_button25.SetLabel(str(item.lvl))
                case "Strength":
                    self.m_button26.SetLabel(str(item.lvl))
                case "Agility":
                    self.m_button27.SetLabel(str(item.lvl))
                case "Smithing":
                    self.m_button28.SetLabel(str(item.lvl))
                case "Defence":
                    self.m_button29.SetLabel(str(item.lvl))
                case "Herblore":
                    self.m_button30.SetLabel(str(item.lvl))
                case "Fishing":
                    self.m_button31.SetLabel(str(item.lvl))
                case "Ranged":
                    self.m_button32.SetLabel(str(item.lvl))
                case "Thieving":
                    self.m_button33.SetLabel(str(item.lvl))
                case "Cooking":
                    self.m_button34.SetLabel(str(item.lvl))
                case "Prayer":
                    self.m_button35.SetLabel(str(item.lvl))
                case "Crafting":
                    self.m_button36.SetLabel(str(item.lvl))
                case "Firemaking":
                    self.m_button37.SetLabel(str(item.lvl))
                case "Magic":
                    self.m_button38.SetLabel(str(item.lvl))
                case "Fletching": 
                    self.m_button39.SetLabel(str(item.lvl))
                case "Woodcutting":
                    self.m_button40.SetLabel(str(item.lvl))
                case "Runecrafting":
                    self.m_button41.SetLabel(str(item.lvl))
                case "Slayer":
                    self.m_button42.SetLabel(str(item.lvl))
                case "Farming":
                    self.m_button43.SetLabel(str(item.lvl))
                case "Construction":
                    self.m_button44.SetLabel(str(item.lvl))
                case "Hunter":
                    self.m_button45.SetLabel(str(item.lvl))
                case "Summoning":
                    self.m_button46.SetLabel(str(item.lvl))
                case "Dungeoneering":
                    self.m_button47.SetLabel(str(item.lvl))
                case "Divination":
                    self.m_button48.SetLabel(str(item.lvl))
                case "Invention":
                    self.m_button49.SetLabel(str(item.lvl))
                case "Archaeology":
